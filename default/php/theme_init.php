...
head_add_css('/view/theme/utsukta-default/css/default/bootstrap.min.css');
...
head_add_js('/view/theme/utsukta-default/js/color-modes.js');
head_add_js('/view/theme/utsukta-default/js/custom.js');
head_add_js('/view/theme/utsukta-default/js/bootstrap.bundle.min.js');
