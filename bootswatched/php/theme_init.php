...
head_add_css('/view/theme/bootswatched/css/sketchy/bootstrap.min.css');
head_add_css('/view/theme/bootswatched/css/fork-awesome.min.css');
...
head_add_js('/view/theme/bootswatched/js/color-modes.js');
head_add_js('/view/theme/bootswatched/js/custom.js');
head_add_js('/view/theme/bootswatched/js/bootstrap.bundle.min.js');
